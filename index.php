...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            ...
            <li><span>Image 02</span><div><h3>RAMADA</h3></div></li>
            <li><span>Image 03</span><div><h3>NAPLES</h3></div></li>
            <li><span>Image 04</span><div><h3>FLORIDA</h3></div></li>
            <li><span>Image 05</span><div><h3>RAMADA</h3></div></li>
            <li><span>Image 06</span><div><h3>RAMADA</h3></div></li>
        </ul>
        <div class="container">
            
            <header>
                <h1> <span>RAMADA</span></h1>
